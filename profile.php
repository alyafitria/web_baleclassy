        ...
        <div class="portfolio-info">
          <div class="row">
            ...
            <div class="col-lg-8 pt-4 pt-lg-0 content">
              <!-- <h3><?php echo $_SESSION["buyer"]['name']?></h3> -->
              <div class="row">
                <div class="col-6">
                  <ul>
                    <li><i class="bi bi-rounded-right"></i> <strong>Name :</strong> <?php echo $_SESSION["buyer"]['name']?></li>
                    <li><i class="bi bi-rounded-right"></i> <strong>Username : </strong>@<?php echo $_SESSION["buyer"]['usn']?></li>
                    <li><i class="bi bi-rounded-right"></i> <strong>Email :</strong> <?php echo $_SESSION["buyer"]['email']?></li>
                    <li><i class="bi bi-rounded-right"></i> <strong>Phone :</strong> <?php echo $_SESSION["buyer"]['phone']?></li>
                    <li><i class="bi bi-rounded-right"></i> <strong>Address :</strong> <?php echo $_SESSION["buyer"]['address']?></li>
                  </ul>
                </div>
              </div>
            </div>
