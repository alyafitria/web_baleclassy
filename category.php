...
<head>
  ...
  <title>Shop - Bale Classy Outfit</title>
              ...
              $b = $koneksi->query($a);
                while ($c = $b -> fetch_array()) {
                  ...
                  <tr>
                      ...
                      <td><?php echo $c['price_prod']; ?></td>
                      <td></td>
                      <td>
                        <a href="?page=product&deleteproduct=<?php echo $c['id_prod']; ?>" class="btn btn-danger btn-sm" onclick="return confirm ('yakin mo apus?')">Remove From Cart</a>
                      </td>
                  </tr>
                  <?php
                }
